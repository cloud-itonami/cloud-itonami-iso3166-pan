(ns marketentry.registry
  ...
  filing -- every jurisdiction assigns its own format (for Panama:
  PanamaCompra registration numbers, DGI RUC numbers, MICI Aviso de
  Operación numbers each have their own real formats this actor does
  not reproduce). This namespace does NOT invent one; it builds a
  ...
  call to any real procurement portal (PanamaCompra included). It
