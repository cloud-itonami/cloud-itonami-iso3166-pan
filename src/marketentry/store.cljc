(ns marketentry.store
  "SSoT for the PAN market-entry compliance actor, behind a `Store`
  ...
  Each engagement also carries `:sector` and
  `:non-panamanian-ownership?` -- the ground truth
  `marketentry.governor`'s flagship Art. 288 retail-trade check
  independently verifies. This is SECTOR-CONDITIONAL: only a
  `\"retail-trade\"` sector with `:non-panamanian-ownership? true`
  is a violation, never a blanket foreign-ownership ban.
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Bahia Digital Panama S.A." :portal "PanamaCompra"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :sector "professional-services" :non-panamanian-ownership? false
             :drafted? false :submitted? false
             :jurisdiction "PAN" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "PanamaCompra"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :sector "professional-services" :non-panamanian-ownership? false
             :drafted? false :submitted? false
             :jurisdiction "ATL" :status :intake}
    "eng-3" {:id "eng-3" :operator "Istmo Consultores" :portal "PanamaCompra"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 999000.0
             :sector "professional-services" :non-panamanian-ownership? false
             :drafted? false :submitted? false
             :jurisdiction "PAN" :status :intake}
    "eng-4" {:id "eng-4" :operator "Foreign Retail Ventures Inc" :portal "PanamaCompra"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :sector "retail-trade" :non-panamanian-ownership? true
             :drafted? false :submitted? false
             :jurisdiction "PAN" :status :intake}
    "eng-5" {:id "eng-5" :operator "Canal Logistics Advisory" :portal "PanamaCompra"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :sector "logistics-consulting" :non-panamanian-ownership? true
             :drafted? false :submitted? false
             :jurisdiction "PAN" :status :intake}
    "eng-6" {:id "eng-6" :operator "Casco Viejo Public Works" :portal "PanamaCompra"
             :base-fee 400000 :monthly-rate 25000 :monitoring-months 6
             :claimed-fee 550000.0
             :sector "construction" :non-panamanian-ownership? false
             :drafted? false :submitted? false
             :jurisdiction "PAN" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               sector non-panamanian-ownership?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? non-panamanian-ownership?)     (assoc :engagement/non-panamanian-ownership? non-panamanian-ownership?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/sector :engagement/non-panamanian-ownership?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :non-panamanian-ownership? (boolean (:engagement/non-panamanian-ownership? m))
