# Business Model: Independent Public-Sector Market-Entry & Procurement Compliance Service — Panama

## Classification

- Repository: `cloud-itonami-iso3166-pan`
- ISO 3166: `PAN` (Panama)
...
- Social impact: [:panamanian-sme-market-access :public-spend-transparency :cross-border-friction-reduction]

## Customer

- an already-incorporated `cloud-itonami-cofog-{code}` /
  `cloud-itonami-isco-{code}` / `cloud-itonami-unspsc-{segment}` /
  `cloud-itonami-{ISIC}` operator wanting to bid on a Panamanian
  public contract
...
- registration walkthrough for PanamaCompra (panamacompra.gob.pa), the
  Electronic System of Public Procurement of the Republic of Panama, and
  its Registry of Proponents administered by the General Directorate of
  Public Procurement (Dirección General de Contrataciones Públicas)
- business/tax registration checklist: an entry in the Registro Público
  (Public Registry, a dependency of the Ministry of Government and
  Justice), the sole property/corporate registry required for
  corporations and foundations
- local-content / preferential-procurement navigation: Panamanian
...
- this service does **not** provide legal or tax advice; characterization
  ...
  routes to Panamanian-licensed counsel or a registered agent
...
- **`cloud-itonami-cofog-{code}`**: a jurisdiction-agnostic operator
  ...
  blueprint AND this one to operate in Panama).
